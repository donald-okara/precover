...
buildscript {
    val projectVersion = project.findProperty("precover.version")?.toString() ?: "1.0.4"
            ...
            object : org.gradle.api.Action<Any> {
                override fun execute(subExtension: Any) {
                    try {
                        ...
                        subClz.getMethod("PREVIEW_PRESENCE", org.gradle.api.Action::class.java).invoke(
                            subExtension,
                            object : org.gradle.api.Action<Any> {
                        ...
                        subClz.getMethod("THEME_COVERAGE", org.gradle.api.Action::class.java).invoke(
                            subExtension,
                            object : org.gradle.api.Action<Any> {
                                override fun execute(ruleConfig: Any) {
                                    val ruleClz = ruleConfig.javaClass
                        ...
                        subClz.getMethod("FONT_SCALE_COVERAGE", org.gradle.api.Action::class.java).invoke(
                            subExtension,
                            object : org.gradle.api.Action<Any> {
                                override fun execute(ruleConfig: Any) {
                                    val ruleClz = ruleConfig.javaClass
